...
| 🟠 High | `frontend/package.json:69` | Supply Chain | 0.8 | postcss==8.4.32 |
...
| 🟠 High | `frontend/src/components/BacktestStudio.tsx:3405` | Output Handling | 0.65 | dangerouslySetInnerHTML={ |
| 🟠 High | `frontend/src/components/BacktestStudio.tsx:3494` | Output Handling | 0.65 | dangerouslySetInnerHTML={ |
| 🟠 High | `frontend/src/components/BacktestStudio.tsx:3551` | Output Handling | 0.65 | dangerouslySetInnerHTML={ |
| 🟠 High | `frontend/src/components/BacktestStudio.tsx:4184` | Memory Poisoning | 0.8 | wipe state |
| 🟠 High | `frontend/src/components/DataLab.tsx:1597` | Output Handling | 0.65 | dangerouslySetInnerHTML={ |
